...
contract DeployVault is Script {
    ...
    // Market ID: 0xef2c308b5abecf5c8750a1aa82b47c558005feb7a03f4f8e1ad682d71ac8d0ba
    ...
    MarketParams marketParams = MarketParams({
        ...
        oracle: 0x0cB1928EcA8783F05a07D9Ae2AfB33f38BFBEb78,         // mF-ONE/USDC oracle (verified)
        irm: ADAPTIVE_CURVE_IRM,                                       // Adaptive Curve IRM
        ...
        returns (VaultV2 vault, AllowlistGate gate, MorphoMarketV1AdapterV2 adapter, address adapterFactory)
    {
        ...
        console.log("  Market: MF-ONE-USDC");
        console.log("  Collateral:", MF_ONE);
