...
contract DeployVault is Script {
    ...
    // MF-ONE-USDC Market (verified from Morpho app 2025-12-25)
    ...
    // All parameters verified against production market
    bytes32 constant MARKET_ID = 0xef2c308b5abecf5c8750a1aa82b47c558005feb7a03f4f8e1ad682d71ac8d0ba;

    // MF-ONE collateral token address
    address constant MF_ONE = 0x238a700eD6165261Cf8b2e544ba797BC11e466Ba;

    // Production-verified market parameters for MF-ONE-USDC
    // Loan Token: USDC (lenders provide USDC)
    // Collateral Token: mF-ONE (borrowers collateralize with mF-ONE)
    // Oracle: mF-ONE/USDC price feed (current price ~0.96)
    // IRM: Adaptive Curve (target utilization 90%)
    // LLTV: 91.5% (liquidation threshold)
    MarketParams marketParams = MarketParams({
        loanToken: USDC,
        collateralToken: MF_ONE,
        oracle: 0x0cB1928EcA8783F05a07D9Ae2AfB33f38BFBEb78,
        irm: ADAPTIVE_CURVE_IRM,
        lltv: 915000000000000000 // 91.5% (0.915 * 1e18)
    });
